...

{
  ...
  "salary": {
    ...
    "type": "до вычета налогов|после вычета налогов|не указано_или_null_если_не_указана"
  },
  "location": {
    "city": "город",
...
3. ЗАРПЛАТА:
   ...
   - НЕ ИСПОЛЬЗУЙ "не указано" или другие значения - только null!
...
- НЕ ПРИДУМЫВАЙ и НЕ УГАДЫВАЙ зарплату!
- НЕ ИЩИ зарплату в общем тексте описания!
- НЕ ИСПОЛЬЗУЙ "не указано", "по договоренности" или другие значения - только null!
